    ...
    <div className={`container ${collect ? "" : "hide"}`}>
      <div className="orderForm">
        ...
        <div className="personalData">
          <p className="dataText" id="dataText1">
            Personal data
          </p>
        ...
        <div className="deliveryData">
          <p className="dataText" id="dataText2">
            Delivery address
          </p>
          <div className="dataInputs">
            <p>Street: {street}</p>
        ...
        <div className="orderBtns">
          <button onClick={stepOne} className="registerBtn">
            {" "}
            Back{" "}
          </button>
          <button onClick={handleCartClearance} className="registerBtn">
            Confirm
          </button>
        </div>
      </div>
